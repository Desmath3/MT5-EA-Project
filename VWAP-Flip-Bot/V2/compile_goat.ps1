...
$sourceFile = Join-Path $PSScriptRoot "VWAP Flip bot V2.mq5"
$logFile    = Join-Path $PSScriptRoot "compile_goat_cmd.log"
...
# Give MetaEditor a short moment to flush the log.
