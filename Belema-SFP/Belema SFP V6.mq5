...
#property description "Version 1.26 fixes the trade distance filter to include pending orders and adds proximity cancellation for limit orders."
...
// --- CORRECTED: Function to check distance from existing trades AND pending orders ---
bool IsTradeTooClose(double newEntryPrice)
  {
   ...
   // --- CHECK 1: Loop through OPEN POSITIONS ---
   for(int i = PositionsTotal() - 1; i >= 0; i--)
     {
   ...
   // --- CHECK 2: Loop through PENDING ORDERS ---
