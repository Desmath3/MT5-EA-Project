   ...
   if(EnablePremiumDiscountFilter)
     {
      ...
      if(!isBuy && current_price <= midpoint)
        {
...
void EnforceHedgeRule()
  {
   ...
   // No pending to cancel, but perhaps close opposing if needed? No, original doesn't close, just prevents new.
  }
void CheckBreakeven()
  {
...
void UpdateManagedTrades()
  {
   // No pending, but keep for consistency if needed
  }
